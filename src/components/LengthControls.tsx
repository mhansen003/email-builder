...
const OPTIONS: { id: LengthId; label: string; description: string }[] = [
  { id: "condense", label: "Short", description: "Brief & concise" },
  { id: "default", label: "Default", description: "Standard length" },
  { id: "extend", label: "Detailed", description: "Thorough & complete" },
];
              ...
              return (
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-text-muted text-xs ml-1.5">{option.description}</span>
                  </div>
                </button>
              );
            })}
