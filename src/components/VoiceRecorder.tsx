  ...
  return (
    <div className="flex flex-col items-center gap-3 py-4">
      ...
      <div className="flex items-center gap-6">
        ...
        {/* Interview button (purple) — same size as mic */}
        <button
          onClick={() => {
            setShowIdleGlow(false);
            onInterview();
          }}
          className="relative w-20 h-20 rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer group bg-bg-card hover:bg-bg-secondary border-2 border-accent-purple/40 hover:border-accent-purple shadow-[0_0_15px_rgba(168,85,247,0.2)] hover:shadow-[0_0_25px_rgba(168,85,247,0.4)]"
        ...
        >
          ...
          <svg className="w-8 h-8 relative z-10 text-text-secondary group-hover:text-accent-purple transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
