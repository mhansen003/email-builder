      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        {isSupported && (
          ...
          >
            ...
            <svg
              className={`w-7 h-7 sm:w-8 sm:h-8 relative z-10 transition-colors ${
        ...
        <button
          ...
          className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer group bg-bg-card hover:bg-bg-secondary border-2 border-accent-purple/40 hover:border-accent-purple shadow-[0_0_15px_rgba(168,85,247,0.2)] hover:shadow-[0_0_25px_rgba(168,85,247,0.4)]"
        ...
        >
          ...
          <svg className="w-7 h-7 sm:w-8 sm:h-8 relative z-10 text-text-secondary group-hover:text-accent-purple transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
